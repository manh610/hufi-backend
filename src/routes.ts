...
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
import { StudentEventController } from './components/studentEvent/studentEvent.controller';
...
export function RegisterRoutes(app: express.Router) {
    ...
    // ###########################################################################################################
        app.post('/teachers',
            ...
            ...(fetchMiddlewares<RequestHandler>(TeacherController.prototype.create)),

            function TeacherController_create(request: any, response: any, next: any) {
            const args = {
        ...
        app.post('/teachers/login',
            ...
            function TeacherController_login(request: any, response: any, next: any) {
            const args = {
                    data: {"in":"body","name":"data","required":true,"ref":"ITeacherLogin"},
            };
        ...
        app.post('/events',
            ...
            ...(fetchMiddlewares<RequestHandler>(EventController.prototype.create)),

            function EventController_create(request: any, response: any, next: any) {
            const args = {
                    data: {"in":"body","name":"data","required":true,"ref":"IEvent"},
            };
        ...
        app.get('/events',
            ...(fetchMiddlewares<RequestHandler>(EventController)),
            ...(fetchMiddlewares<RequestHandler>(EventController.prototype.getAllEvent)),

            function EventController_getAllEvent(request: any, response: any, next: any) {
            const args = {
            };
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.post('/events/eventInTime',
            ...(fetchMiddlewares<RequestHandler>(EventController)),
            ...(fetchMiddlewares<RequestHandler>(EventController.prototype.getEventInTime)),

            function EventController_getEventInTime(request: any, response: any, next: any) {
            const args = {
                    data: {"in":"body","name":"data","required":true,"ref":"IReqGetEventInTime"},
            };
            ...
            try {
              ...
              const promise = controller.getEventInTime.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
        ...
        app.delete('/events/:eventId',
            ...(fetchMiddlewares<RequestHandler>(EventController)),
            ...(fetchMiddlewares<RequestHandler>(EventController.prototype.deleteTask)),

            function EventController_deleteTask(request: any, response: any, next: any) {
            const args = {
                    eventId: {"in":"path","name":"eventId","required":true,"dataType":"string"},
            };
        ...
        app.put('/students/:studentId',
            ...(fetchMiddlewares<RequestHandler>(StudentController)),
            ...(fetchMiddlewares<RequestHandler>(StudentController.prototype.updateMember)),

            function StudentController_updateMember(request: any, response: any, next: any) {
            const args = {
                    studentId: {"in":"path","name":"studentId","required":true,"dataType":"string"},
                    data: {"in":"body","name":"data","required":true,"ref":"IUpdateMember"},
            };
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.post('/studentEvents',
            ...(fetchMiddlewares<RequestHandler>(StudentEventController)),
            ...(fetchMiddlewares<RequestHandler>(StudentEventController.prototype.create)),
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.delete('/studentEvents/delete',
            ...(fetchMiddlewares<RequestHandler>(StudentEventController)),
            ...(fetchMiddlewares<RequestHandler>(StudentEventController.prototype.delete)),

            function StudentEventController_delete(request: any, response: any, next: any) {
            const args = {
                    input: {"in":"body","name":"input","required":true,"ref":"ICheckStudentEventReq"},
            };
